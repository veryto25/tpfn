...
class Catalogo:
    ...
    def agregar_producto(self, codigo, modelo, cantidad, precio, imagen1, imagen2, imagen3, descripcion, estilo, proveedor):
        ...
        sql = "INSERT INTO productos (codigo, modelo, cantidad, precio, imagen1_url, imagen2_url, imagen3_url, descripcion, estilo, proveedor) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
    ...
    def mostrar_producto(self, codigo):
        ...
        if producto:
            ...
            print(f"Imagen3.....: {producto['imagen2_url']}")
